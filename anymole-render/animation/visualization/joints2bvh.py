import animation.visualization.Animation as Animation

from animation.visualization.InverseKinematics import BasicInverseKinematics, BasicJacobianIK, InverseKinematics
from animation.visualization.Quaternions import Quaternions
import animation.visualization.BVH_mod as BVH
from animation.visualization.remove_fs import *
from animation.visualization.utils.quat import ik_rot, between, fk, ik
...
class Joint2BVHConvertor:
    def __init__(self):
        self.template = BVH.load('./animation/visualization/data/template.bvh', need_quater=True)
